...
int Delete_Elemnt(float* arr, int *arr_size, float value){
...
int main(){
    ...
    {
    case 0:
        Print_Array(arr, size); goto LOOP_BEGIN; break;
    case 1:
    ...
    case 3:
        ...
        scanf("%f", &value);
        pos = Delete_Elemnt(arr, &size, value);
        if(pos >= 0 && pos <=size){
